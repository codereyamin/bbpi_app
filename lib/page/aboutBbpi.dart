...
class _AboutBbpiState extends State<AboutBbpi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('About BBPI'),leading: IconButton(onPressed: (){Navigator.push(context, new MaterialPageRoute(builder: (context) => new CustomDrawer()));}, icon: Icon(Icons.arrow_back))),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text('1. Introduction',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,),),
            ),
           ...
           Padding(padding: const EdgeInsets.all(12.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('The institute offers 4-years Diploma-in-Engineering courses in the following technologies:-'),
                  SizedBox(height: 10,),
             ...
             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('6. Staves',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
            ...
            Padding(padding: const EdgeInsets.all(12.0),
             ...
             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('7. Administrative & Academic Accommodation',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(padding: const EdgeInsets.all(12.0),
              child: Text("The main campus including two large five storied buildings, two storied buildings is now accommodating the class rooms. Office, Library, Workshops and Laboratories."),
            ),


             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('8. Residential Accommodation',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(padding: const EdgeInsets.all(12.0),
              child: Text("It has only a one storied “Banglo” for the principal and a 4 storied building for 4th class employees."),
            ),

             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('9. Governing Authority',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
            ...
            Padding(padding: const EdgeInsets.all(12.0),
             ...
             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('10. Play Ground',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(padding: const EdgeInsets.all(12.0),
              child: Text("The institute has a little playground of half an acre land having facility only for mini Football or Hockey or Cricket or Volleyball or Badminton and other outdoor games & Athletic."),
            ),


            Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('11. Workshop and Laboratory',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(padding: const EdgeInsets.all(12.0),
              child: Text("The Workshops and Laboratories are rich and well equipped with modern machines and instruments that grasp excellent opportunity for the training of the learners with practices to make fit for the industries. Requisite amount of money is provided by the government every year to keep the workshops with industrial development of the day."),
            ),

             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('12. Library',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
            ...
            Padding(padding: const EdgeInsets.all(12.0),
             ...
             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('13. Study Tour',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(padding: const EdgeInsets.all(12.0),
              child: Text("Study tours are arranged by the different technologies for their students in every year in the institute to have recreation and practical experiences."),
            ),

             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('14. Stipends',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
            ...
            Padding(padding: const EdgeInsets.all(12.0),
             ...
             Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text('15. Scout',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ),
            ...
            Padding(padding: const EdgeInsets.all(12.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Composition and function of diferent councils and committees."),
                  SizedBox(height: 8,),
                  Text("1. i) Administrative council:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                  SizedBox(height: 8,),
                  Text("The administrative council shall be formed by the principal (chairman), Vice-principal, Chief instructor/Departmental Head, Representatives from institute of Diploma-in-engineers, Bangladesh (IDEB), Bangladesh polytechnic Teachers Association (BPTA), Bangladesh polytechnic Shiksak Parishad (BPSP), BAKASIOKAS."),
                  SizedBox(height: 8,),
                  Text("2. ii) Academic council:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                  SizedBox(height: 8,),
                  Text("The academic council shall be comprised of the Principal (Chairman), Vice-principal, Chief Instructor/Departmental Head, Representatives from IDEB, BPTA, BPSP,    Registrar (member-secretary). Its function shall be determined to the policies concerning the followings."),

                  SizedBox(height: 8,),
                  Text("1.The conduct of the learners."),
                  SizedBox(height: 8,),
                  Text("2.The academic criteria/standard & requisites of the learners."),
                  SizedBox(height: 8,),
                  Text("3.The promotion of the learners through examinations within the Institute."),
                  SizedBox(height: 8,),
                  Text("4.Publication of the result of the examination in the Institute."),
                  SizedBox(height: 20,),
                ],
              ),
            ),
