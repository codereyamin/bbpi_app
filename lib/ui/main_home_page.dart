...
import 'package:bbpi_app/ui/Department.dart';
import 'package:bbpi_app/ui/aboutBbpi.dart';
import 'package:bbpi_app/ui/bloodCollection.dart';
import 'package:bbpi_app/ui/bookList.dart';
import 'package:bbpi_app/ui/classRoting.dart';
import 'package:bbpi_app/ui/collageResult.dart';
import 'package:bbpi_app/ui/newsPeed.dart';
import 'package:bbpi_app/ui/techer.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: AnimatedContainer(
        ...
        transform: Matrix4.translationValues(xoffset, yoffset, 0)..scale(isDrawrOpen? 0.90:1.00)..rotateZ(isDrawrOpen? -50:0),
        duration:const Duration(milliseconds: 200),
        
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius:isDrawrOpen? BorderRadius.circular(40):BorderRadius.circular(0),
        ),
                   ...
                   Row(
                    children: [
                      Expanded(child: _customButton(
                        ...
                        onTab: (){
                          Navigator.push(context, new MaterialPageRoute(builder: (context) => new ColageResult()));
                        },
                      ),),
                      Expanded(child: _customButton(
                        context: context,
                        ...
                        onTab: (){
                           Navigator.push(context, new MaterialPageRoute(builder: (context) => new ClassRoting()));
                        },
                      ))
                    ]
                  ),
                   ...
                   Row(
                    children: [
                      Expanded(child: _customButton(
                        ...
                        onTab: (){
                          Navigator.push(context, new MaterialPageRoute(builder: (context) => new BookList()));
                        },
                      ),),
                      Expanded(child: _customButton(
                        context: context,
                        ...
                        onTab: (){
                           Navigator.push(context, new MaterialPageRoute(builder: (context) => new BloodCollection()));
                        },
                      ))
                    ]
                  ),
